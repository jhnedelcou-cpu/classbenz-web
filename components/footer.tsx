...
export function Footer() {
  return (
    <footer className="bg-card border-t border-border relative">
      ...
      {/* --- DOCK MAESTRO (Controla la posición de todo) --- */}
      <div className="fixed bottom-6 right-6 z-[9999] flex flex-col gap-4 items-end">

        {/* 1. Chatbot */}
        <ChatAssistant />

        {/* 2. Botón WhatsApp (Gris / Glassmorphism) */}
        <a
          href="https://wa.me/5491154122154?text=Hola%20Class%20Benz!%20Quisiera%20consultar%20por%20un%20vehículo."
          target="_blank"
          rel="noopener noreferrer"
          className="p-4 rounded-full bg-zinc-700/80 backdrop-blur-md border border-white/10 
                     shadow-lg hover:bg-zinc-600 hover:scale-105 transition-all duration-300 
